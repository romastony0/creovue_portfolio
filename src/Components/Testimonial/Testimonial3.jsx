  ...
  const testimonialContent = [
    {
      ...
      subtitle: "Founder, Zently Digital",
      title: "Aanya Kapoor",
      content:
        "Creovue helped us double our social engagement in just three months. Their design and ad targeting expertise is unmatched. Truly a strategic partner for growth.",
    },
    {
      img: "/assets/img/testimonial/05.png",
      subtitle: "Marketing Head, FabWear",
      title: "Rohit Desai",
      content:
        "We needed a complete overhaul of our digital presence. Creovue delivered—from stunning visuals to high-performing paid campaigns. Impressed with their professionalism.",
    },
  ];
